...
void MessageQueue<T>::send(T &&msg)
{
    ...
    std::string receivedMessage =
        msg == TrafficLightPhase::red ? "red" : "green";
    std::cout << "Sending current phase: " << receivedMessage << ". Not yet to be received" << std::endl;
...
void TrafficLight::waitForGreen()
{
    ...
    while (true) {
        ...
        TrafficLightPhase currentTrafficLight = this->_message.receive(); 

        if (currentTrafficLight == TrafficLightPhase::green){
            return; 
        }
    }
}
